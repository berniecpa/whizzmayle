...
<form method="post">
    <div class="box box-primary borderless">
        ...
        <div class="alert alert-info">
            If you run into issues when setting up the cron jobs, please read <a target="_blank" href="https://www.mailwizz.com/kb/what-cron-jobs-are-why-do-i-need-to-add-them-and-how/"><em>this</em></a> article for solutions.<br />
        </div>
